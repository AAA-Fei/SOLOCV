...
- 🛰️ [查看追踪检测模型推理文档](./infer/tracker/README.md)
## 🧠 已支持的模型列表

| 🏷️ 分类 (Classification) | 🎯 目标检测 (Detection) | 🧩 分割 (Segmentation) | 🧍 人体姿态 (Pose) | 🔤 OCR识别 (OCR) | 🛣️ 深度估计 (Depth) | 🛰️ 追踪 (Tracking) |
|:---|:--------------------|:---|:--|:---|:---|:---|
| ShuffleNetV2 | YOLO                | YOLO-Seg | YOLO-Pose | Plate | Lite-Mono | DeepSort |
